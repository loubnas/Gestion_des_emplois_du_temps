           ...
           <form action="saveupdate" method="POST">  <div class="row">
             <?php foreach ($gl as $row)?>
                <div class="col-md-4"> 
                    ...
                    <input type="text" class="form-control" name="libelle" value="<?php echo $row['LibelleG'];?>"> 
                </div>
                <div class="col-md-4"> 
                    <label>Effectif :</label> 
                    <input type="number" class="form-control" name="effectif" value="<?php echo $row['effectifG'];?>"> 
                </div>
                <div class="col-md-2"> 
